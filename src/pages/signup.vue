            ...
            <form @submit.prevent="signup" class="space-y-4">
                <div>
                    ...
                    <div class="text-sm font-medium text-gray-500">
                        <p>Минимальная длина: 4 символа. Ваше имя может содержать латинские буквы и цифры.</p>
                    </div>
                </div>
                <div>
                    ...
                    <div class="text-sm font-medium text-gray-500">
                        <p>Адрес вашей электронной почты будет использоваться для входа.</p>
                    </div>
                </div>
                <div>
                    ...
                    <div class="text-sm font-medium text-gray-500">
                        <p>Минимальная длина: 8 символов. Ваш пароль должен содержать строчные и заглавные буквы, цифры, а также спецсимволы.</p>
                    </div>
                </div>
                <div>
