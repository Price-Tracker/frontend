                ...
                <nav aria-label="Sidebar" class="mt-5">
                  <div class="space-y-1 px-2">
                    <a v-for="item in navigation" :key="item.name" :href="item.href"
                      class="group flex items-center rounded-md p-2 text-base font-medium text-blue-gray-600 hover:bg-blue-gray-50 hover:text-blue-gray-900">
                      <component :is="item.icon" class="mr-4 h-6 w-6 text-blue-gray-400 group-hover:text-blue-gray-500"
                        aria-hidden="true" />
                      {{ item.name }}
                    </a>
                  </div>
                ...
                <a href="#" class="group block flex-shrink-0">
                  <div class="flex items-center">
                    ...
                    <div class="ml-3">
                      ...
                      <p class="text-sm font-medium text-blue-gray-500 group-hover:text-blue-gray-700">Account Settings
                      </p>
                    </div>
                  </div>
                </a>
            ...
            <nav aria-label="Sections"
              ...
              <div class="min-h-0 flex-1 overflow-y-auto">
                <a v-for="item in subNavigation" :key="item.name" :href="item.href"
                  ...
                  <component :is="item.icon" class="-mt-0.5 h-6 w-6 flex-shrink-0 text-blue-gray-400"
                    aria-hidden="true" />
              ...
              <div class="mx-auto max-w-3xl py-10 px-4 sm:px-6 lg:py-12 lg:px-8">
                ...
                <form class="divide-y-blue-gray-200 mt-6 space-y-8 divide-y">
                  <div class="grid grid-cols-1 gap-y-6 sm:grid-cols-6 sm:gap-x-6">
                    ...
                    <div class="sm:col-span-6">
                      ...
                      <div class="mt-1 flex rounded-md shadow-sm">
                        <span
                          class="inline-flex items-center rounded-l-md border border-r-0 border-blue-gray-300 bg-blue-gray-50 px-3 text-blue-gray-500 sm:text-sm">workcation.com/</span>
                    ...
                    <div class="sm:col-span-6">
                      ...
                      <p class="mt-3 text-sm text-blue-gray-500">Brief description for your profile. URLs are hyperlinked.
                      </p>
                    </div>
                  ...
                  <div class="grid grid-cols-1 gap-y-6 pt-8 sm:grid-cols-6 sm:gap-x-6">
                    ...
                    <div class="sm:col-span-3">
                      <label for="email-address" class="block text-sm font-medium text-blue-gray-900">Email
                        address</label>
                  ...
                  <p class="text-sm text-blue-gray-500 sm:col-span-6">This account was created on <time
