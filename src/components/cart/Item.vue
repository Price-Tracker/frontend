<template>
	<div class="flex flex-col max-w-3xl p-6 space-y-4 sm:p-10 bg-gray-50 text-gray-800">
					...
					<div class="flex flex-col justify-between w-full pb-4">
						<div class="flex justify-between w-full pb-2 space-x-2">
							...
							<div class="text-right">
								...
								<p class="text-sm line-through text-gray-400">150€</p>
							</div>
						</div>
						<div class="flex text-sm divide-x">
							<button type="button" class="flex items-center px-2 py-1 pl-0 space-x-1">
					...
					<div class="flex flex-col justify-between w-full pb-4">
						<div class="flex justify-between w-full pb-2 space-x-2">
							...
							<div class="text-right">
								...
								<p class="text-sm line-through text-gray-400">15.99€</p>
							</div>
						</div>
						<div class="flex text-sm divide-x">
							<button type="button" class="flex items-center px-2 py-1 pl-0 space-x-1">
		...
		<div class="flex justify-end space-x-4">
			<button type="button" class="px-6 py-2 border rounded-md border-blue-600">Back
				<span class="sr-only sm:not-sr-only">to shop</span>
			</button>
			<button type="button" class="px-6 py-2 border rounded-md bg-blue-600 text-gray-50 border-blue-600">
