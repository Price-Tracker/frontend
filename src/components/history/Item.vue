<template>
    ...
    <div class="relative">
        <div class="mt-4 mb-4 flex gap-x-4">
            <img v-if="historyItem.product.picture_url" :src="historyItem.product.picture_url"
                class="px-4 py-4 h-40 w-40 flex-none">
            <img v-else class="px-4 py-4 h-40 w-40 flex-none"
